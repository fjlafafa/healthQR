...
export function TemperaturePage({navigation}: any) {
    ...
    return <ScreenTemplate goBack={goBack}>
        ...
        <TextInputTemplate label='检测体温' value={temperature}
                           onChangeText={(temperature: string) => TemperatureStore.setState({temperature})}/>
        ...
        <ButtonToSendMessage
            ...
            toSendMessage={new UserUpdateTemperature(token, new Temperature(+temperature))}
            text='上传'
            ifSuccess={() => {
