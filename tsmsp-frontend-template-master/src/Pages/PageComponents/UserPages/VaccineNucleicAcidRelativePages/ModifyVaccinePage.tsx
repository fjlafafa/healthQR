...
const setIdentityNumber = (identityNumber: string) =>
  patientInfoStore.setState({ identityNumber });
const setRiskLevel = (riskLevel: string) =>
  patientInfoStore.setState({ riskLevel });
    ...
    <ScreenTemplate goBack={goBack}>
      ...
      <ButtonToSendMessage
        checkBeforeSendMessage={() =>
          Object.values(UserRiskLevel).includes(riskLevel as UserRiskLevel)
        }
        checkElse={() => {
          alert("风险等级错误");
        }}
