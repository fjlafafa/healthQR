...
import {
    HospitalUpdatePatientRecoveryByTokenMessage
} from "Messages/ThirdPartyMessages/HospitalUpdatePatientRecoveryByTokenMessage";
...
export function RecoverPatientPage({navigation}: any) {
    ...
    return <ScreenTemplate goBack={goBack}>
        ...
        />
        <ButtonToSendMessage
            toSendMessage={new HospitalUpdatePatientRecoveryByTokenMessage(token, client.token)}
            text={'恢复病人'}/>
    </ScreenTemplate>
}