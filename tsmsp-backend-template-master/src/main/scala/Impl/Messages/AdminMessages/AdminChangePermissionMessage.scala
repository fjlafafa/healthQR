...
import Types.UserMeta.{Administrator, Role, Token}
import Utils.DBUtils
import org.joda.time.DateTime

import scala.util.Try

case class AdminChangePermissionMessage(adminToken: Token, clientToken:Token, newPermission: Role) extends TSMSPMessage {
